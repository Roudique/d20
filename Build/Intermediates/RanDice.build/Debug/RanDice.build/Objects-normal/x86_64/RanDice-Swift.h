...
SWIFT_MODULE_NAMESPACE_PUSH("RanDice")

SWIFT_CLASS("_TtC7RanDice11AppDelegate")
...
@property (nonatomic, weak) IBOutlet NSPopUpButton * _Null_unspecified selectDicePopup;
@property (nonatomic, weak) IBOutlet NSTextField * _Null_unspecified resultLabel;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7RanDice13RDQRandomizer")
@interface RDQRandomizer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
